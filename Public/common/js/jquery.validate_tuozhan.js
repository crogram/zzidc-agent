	...
	methods: {
		...
		/////////////////////////////////////////////////拓展验证///////////////////////////////////////////////拓展验证////////////////////////////////////////////////////
		 ...
		 isMobile: function(value, element) {
            //手机号码
            return this.optional( element ) || /(^1[3|5|8|7|4][0-9]{9}$)/.test(value);
        },
		...
		chrnumcon: function(value, element) {
            //字母和数字的验证
            return this.optional( element ) || /^([a-zA-Z0-9-+*#]+)$/.test(value);
        },
		onlyZh: function(value, element) {
            //纯中文
