...
/*******************ptype参数*****************************/
	...
	//快云数据库 常量
	const PTYPE_CLOUD_DATABASE="clouddb";
	//SSL 常量
	const PTYPE_SSL="ssl";
...
/************************************************pname参数******************************************/
   ...
   //景安API接口参数 门户I型(Linux) 常量
	...
	//景安API接口参数 云空间子站点增值 常量
	const PNAME_CLOUD_SPACE_ZENG_ZHI_SUB_SITE="zengzhi.zhandian";
	...
	//景安API接口参数 快云服务器获取操作系统 常量
	const PNAME_CLOUDSERVER_OS = "cloudserver.getsystem";
	
	//景安API接口参数 快云服务器获取操作系统 常量
	const PNAME_CLOUDSERVER_SERVER = "cloudserver.server";
	
	//景安API接口参数 IP操作系统 常量
	const PNAME_CLOUDSERVER_IP = "cloudserver.ip";
	...
	//ssl获取开通进度(仅ssl)
	const TID_GET_SSL_BUSINESS=26;
	
	//快云服务器绑定IP(仅快云服务器)
	const TID_IP_BOUND=30;
	
	//快云服务器解绑IP(仅快云服务器)
	const TID_IP_RELIEVE=31;
	
	//快云服务器获取开通、IP进度(仅快云服务器)
	const TID_GET_BUSINESS=32;
	
	//快云服务器获取操作系统
	const TID_SYSTEM_TYPE=39;
	
	//主机验证域名是否备案
	const TID_PROVING_TYPE=41;

	//景安API接口tid参数 查看快云数据库升级状态
	const TID_CLOUDDB_UPLEVEL = 37;
	
	//景安API接口tid参数 获取主机FTP密码
	const TID_VHOST_FTPPWD = 36;
/*******************yid参数*****************************/
