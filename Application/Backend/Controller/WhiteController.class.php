...
use \Common\Respository\WhiteRespository;



class WhiteController extends BackendController
{
	...
	public function _initialize(){
		parent::_initialize();
		$this->model = new \Backend\Model\WhiteModel();
		$this->respository = new WhiteRespository($this->model);
