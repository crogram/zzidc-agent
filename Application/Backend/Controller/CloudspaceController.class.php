...
use Common\Respository\CloudspaceBusinessRespository;
 ...
 * -------------------------------------------------------
 */
class CloudspaceController extends BackendController{
	...
	public function _initialize(){
		parent::_initialize();
		$this->model = new \Backend\Model\CloudspaceModel();
		$this->respository = new CloudspaceBusinessRespository($this->model);
	}
...
// 	}
	...
	public function update(){
		...
		$entity = $this->model->getCloudspaceInfo($id);
...
// 	dump($res);die;
	...
	public function erase(){
		...
		$id = $request['id'];
		//删除业务操作
		$res = $this->respository->eraseCloudspaceBusiness($id);
	...
	public function details() {
		...
		//获取相应的站点信息
		$siteInfo = $this->model->getSiteInfoByCloudspaceId($id);
...
// 		dump($siteInfo);die;
	...
	public function sync(){
		...
		$res = $this->respository->CloudspaceBusinessSynchronizing($id);
// 		dump($this->model);die;
		//返回结果
		if ($res === false) {
			$msg = $this->model->getError();
	...
	public function syncBatch(){
		...
		$flag = $request['flag'];
		//批量同步虚拟主机操作
		$res = $this->respository->syncBatch(GiantAPIParams::PTYPE_CLOUD_SPACE, $flag);
