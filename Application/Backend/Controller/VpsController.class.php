 ...
 * -------------------------------------------------------
 */
class VpsController extends BackendController{
	...
	public function _initialize(){
		parent::_initialize();
		$this->model = new \Backend\Model\VpsModel();
...
// 	dump($res);die;
	...
	public function erase(){
		...
		$id = $request['id'];
		//删除业务操作
		$res = $this->respository->eraseVpsBusiness($id, GiantAPIParams::PTYPE_VPS);
...
// 		dump($entity);die;
	...
	public function sync(){
		...
		$id = $request['id'];
		//同步vps操作
		$res = $this->respository->VpsBusinessSynchronizing($id, GiantAPIParams::PTYPE_VPS);
	...
	public function syncBatch(){
		...
		$flag = $request['flag'];
		//批量同步vps操作
		$res = $this->respository->syncBatch(GiantAPIParams::PTYPE_VPS, $flag);
