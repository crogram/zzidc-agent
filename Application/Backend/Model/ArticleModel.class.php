...
class ArticleModel extends BackendModel{
	...
	protected $insertFields = [
			'type', 'title', 'state','content','create_time','update_at','summary'
	];
	//更新是允许更新的字段
	protected $updateFields = [
			'type', 'title', 'state','content','update_at','summary'
	];
...
// 		$this->fillData = $fill_data;
	...
	protected function _before_insert(&$data, $options){
		...
		$content = mb_convert_encoding($data['content'], 'utf-8');
		if ( mb_strlen($content, 'utf-8') >= 10000*3) {
